...
public class QuestionBank {
    ...
    private String textQuestions [] = {
            ...
            ,"Observe o mapa referente ao alcance do míssil intercontinental desenvolvido pela Coreia do Norte e testado com êxito em julho de 2017:"
           ,"A América Latina pediu ao governo de Nicolás Maduro que aceite ajuda humanitária, a fim de 'descomprimir' a crise que está por trás da migração em massa de venezuelanos pela região, em reunião em Quito, no Equador.Segundo a Organização das Nações Unidas (ONU), cerca de 2,3 milhões de venezuelanos vivem no exterior, dos quais 1,6 milhão abandonaram o país desde 2015, com a piora da escassez de medicamentos e alimentos em meio à hiperinflação que corrói os salários.","."
    ...
    private String multipleChoice [][] = {{"A LIBERAÇÃO INDISCRIMINADA DO PESTICIDA “LINDANO”, QUE TEM POTENCIAL CANCERÍGENO.","A PROIBIÇÃO DO PLANTIO DE MILHO GENETICAMENTE\n" +
            ...
            {"FORTE ATUAÇÃO DA POLÍCIA CONTRA AS FACÇÕES CRIMINOSAS.","VIOLÊNCIA GENERALIZADA EM CIDADES DOMINADAS PELO TRÁFICO DE DROGAS.","ADOÇÃO DE MEDIDA PROVISÓRIA EM 2014 QUE PREVÊ PENAS DURAS PARA CRIMES CONTRA A VIDA.","POLÍTICA DE ENCARCERAMENTO EM MASSA ADOTADO PELO BRASIL."},
            {"A COREIA DO NORTE DIZ QUE O DESENVOLVIMENTO DE ARMAS PROTEGE O PAÍS DE ATAQUES.","COM O NOVO MÍSSIL INTERCONTINENTAL, A PENÍNSULA NORTE-COREANO IGUALA SEU PODERIO BÉLICO AO DOS ESTADOS UNIDOS.","APÓS REUNIÃO COM OS ESTADOS UNIDOS E JAPÃO, A COREIA TOMOU MEDIDAS EFETIVAS PARA DESNUCLEARIZAR A PENÍNSULA.","O DESENVOLVIMENTO DE ARMAS NUCLEARES TEM COLABORAÇÃO DA RÚSSIA."},
            {"DESVALORIZAÇÃO DA MOEDA PARA MOVIMENTAR O COMÉRCIO.","DEPENDÊNCIA DA ECONOMIA VENEZUELANA AO PETRÓLEO.","FALTA DE INVESTIMENTOS NA INDÚSTRIA LOCAL,FORÇANDO O GOVERNO A IMPORTAR PRODUTOS DE PRIMEIRA NECESSIDADE, COMO A PASTA DE DENTE.","INSATISFAÇÃO POPULAR COM A ELEIÇÃO DO PRESIDENTE NICÓLAS MADURO APÓS A MORTE DE HUGO CHÁVEZ."},
            {"A POPULAÇÃO INDÍGENA SEMPRE TEVE FÁCIL ACESSO À ESCOLA E EDUCAÇÃO DE QUALIDADE.","A POPULAÇÃO NÃO-BRANCA É A MAIS AFETADA COM A FALTA DE ACESSO À EDUCAÇÃO.","FATORES EXTERNOS COMO GRAVIDEZ PRECOCE E TRABALHO DOMÉSTICO NÃO CONTRIBUEM PARA O ABANDONO DOS ESTUDOS.","APROXIMADAMENTE 95% DA POPULAÇÃO NÃO-BRANCA DO BRASIL TERMINA A ESCOLA."}
    };

    // array of correct answers - in the same order as array of questions
    private String mCorrectAnswers[] = {"A RENÚNCIA DA APROVAÇÃO DAS PASTAS DA SAÚDE E DO MEIO AMBIENTE, DEIXANDO O CONTROLE DOS AGROTÓXICOS APENAS NAS MÃOS DO MINISTÉRIO DA AGRICULTURA.","A MELHORIA DAS CONDIÇÕES DE SAÚDE E A QUEDA DA TAXA DE FECUNDIDADE.","PERDA DO PODER DE COMPRA DA POPULAÇÃO MOTIVADA PELA HIPERINFLAÇÃO E A ESCASSEZ DE PRODUTOS.","O DOMINGO SANGRENTO, QUANDO MANIFESTANTES NEGROS FORAM ATACADOS AO REIVINDICAR O DIREITO AO VOTO NO ESTADO DO ALABAMA.","PELA PROLIFERAÇÃO DO VÍRUS TAMBÉM EM ÁREAS URBANAS. ANTES, A CONTAMINAÇÃO ERA MAJORITARIAMENTE EM ÁREAS SILVESTRES, PRÓXIMAS A MATAS E FLORESTAS.","B e D","POLÍTICA DE ENCARCERAMENTO EM MASSA ADOTADO PELO BRASIL.","A COREIA DO NORTE DIZ QUE O DESENVOLVIMENTO DE ARMAS PROTEGE O PAÍS DE ATAQUES.","DEPENDÊNCIA DA ECONOMIA VENEZUELANA AO PETRÓLEO.","A POPULAÇÃO NÃO-BRANCA É A MAIS AFETADA COM A FALTA DE ACESSO À EDUCAÇÃO."};
